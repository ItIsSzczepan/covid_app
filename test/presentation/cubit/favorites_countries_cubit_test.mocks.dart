...
// in covid_app/test/presentation/cubit/favorites_countries_cubit_test.dart.
...
import 'favorites_countries_cubit_test.dart' as _i10;
...
/// A class which mocks [FakeError].
///
/// See the documentation for Mockito's code generation for more information.
class MockFakeError extends _i1.Mock implements _i10.FakeError {
  MockFakeError() {
    _i1.throwOnMissingStub(this);
  }

  @override
  dynamic onError(_i5.Failure? failure) =>
      super.noSuchMethod(Invocation.method(#onError, [failure]));
}
