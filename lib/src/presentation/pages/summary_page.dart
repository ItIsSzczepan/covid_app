      ...
      builder: (context, state) {
        ...
        return Column(
          children: [
            ...
            Text(state.countries[state.selectedCountry].record.newConfirmed.toString()),
            Text(state.countries[state.selectedCountry].record.totalConfirmed.toString()),
            Text(state.countries[state.selectedCountry].record.newRecovered.toString()),
            Text(state.countries[state.selectedCountry].record.totalRecovered.toString()),
            Text(state.countries[state.selectedCountry].record.newDeaths.toString()),
            Text(state.countries[state.selectedCountry].record.totalDeaths.toString()),
          ],
        );
      },
    );
